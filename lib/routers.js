...
Router.route('/',{
  ...
  onBeforeAction:function(){
    // console.log(typeof SessionAmplify.get('loginUser'));
   if(SessionAmplify == null || (typeof SessionAmplify.get('loginUser')=='undefined')||SessionAmplify.get('loginUser')==null)
      {  
         this.next();
      }
    else{
...
Router.route('/login',{name:'userlogin',
    onBeforeAction: function () {
      ...
      if((typeof loinUser !='undefined')||loginUser!=null)
      { 
      	Router.go('/main');
      }
      else{
